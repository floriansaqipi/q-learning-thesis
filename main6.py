from q_learning_taxi_env_agent import Environment, VideoRecordingEnvironment, TrainingPlayer, \
    GraphVisualiser, RenderMode, StatisticsRecordingEnvironment, ConvolutionalDeepQLearningConstants, \
    ConvolutionalDeepQLearningAgent, ReplayMemory

from q_learning_taxi_env_agent.hyper_parameters.convolutional_deep_q_learning_hyper_parameters import \
...
agent = ConvolutionalDeepQLearningAgent(video_recording_env, LEARNING_RATE, DISCOUNT_FACTOR, INTERPOLATION_PARAMETER,
                                        START_EPSILON,
