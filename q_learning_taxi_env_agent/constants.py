...
Q_NETWORK_WEIGHTS_PROGRESS_MEMORY_FILE_NAME = "q_network_weights.pth"
...
DEEP_Q_LEARNING_TRAINING_PLAYER_VIDEOS_DIRECTORY_NAME = "training_deep_q_learning_player_videos"
