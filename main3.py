from q_learning_taxi_env_agent import Environment, VideoRecordingEnvironment, DeepQLearningAgent, TrainingPlayer, \
    GraphVisualiser, RenderMode, StatisticsRecordingEnvironment, DeepQLearningConstants
...
env = Environment(DeepQLearningConstants.ENVIRONMENT_LUNAR_LANDER_V3, RenderMode.RGB_ARRAY, SEED)
statistics_recording_env = StatisticsRecordingEnvironment(env, N_TRAINING_EPISODES)
video_recording_env = VideoRecordingEnvironment(statistics_recording_env, RECORD_FREQUENCY, DeepQLearningConstants.TRAINING_PLAYER_VIDEOS_DIRECTORY_NAME)
