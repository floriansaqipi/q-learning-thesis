from q_learning_taxi_env_agent import Environment, VideoRecordingEnvironment, DeepQLearningAgent, InferencePlayer, \
    GraphVisualiser, RenderMode, StatisticsRecordingEnvironment, DeepQLearningConstants, ReplayMemory

from q_learning_taxi_env_agent.hyper_parameters.deep_q_learning_hyper_parameters import N_PLAYING_EPISODES, LEARNING_RATE, \
...
video_recording_env = VideoRecordingEnvironment(statistics_recording_env, RECORD_FREQUENCY, DeepQLearningConstants.INFERENCE_PLAYER_VIDEOS_DIRECTORY_NAME)
